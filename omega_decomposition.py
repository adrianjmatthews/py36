"""Decompose omega into zonal and meridional components using data_analysis.CubeDiagnostics."""
...
# Read psioc data
aa.f_read_data('psioc_lambda',aa.level)
aa.f_read_data('psioc_phi',aa.level)
