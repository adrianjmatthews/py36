...
def source_info(aa):
    ...
    valid_data_sources=['era5trp','era5plp','era5bar','era5mcw','era5ewa','erainterim','erainterimEK1','erainterimNEK1','erainterimNEK1T42','erainterimEK2','erainterimEK3','erainterimER1','erainterimER2','imergplp','imergmcw','imergmts','imergmt2','imergnpl','imergnp2','imergtrm','imergtrmp1','ncepdoe','ncepdoegg','ncepncar','olrcdr','olrinterp','ostial4nrttrp','ostial4reptrp','sg579m031oi01','sg534m031oi01','sg532m031oi01','sg620m031oi01','sg613m031oi01','sgallm031oi01','sstrey','trmm3b42v7','trmm3b42v7p1','trmm3b42v7p2','trmm3b42v7p3','trmm3b42v7p4','tropflux','hadgem2esajhog','glorys12v1','cmap']
...
class DataConverter(object):
    ...
    def read_cube(self):
        ...
        elif self.source in ['era5trp_plev_h','era5plp_plev_h','era5mcw_plev_h','era5ewa_plev_h','era5plp_sfc_h','era5bar_sfc_h','era5mcw_sfc_h']:
        ...
        if self.data_source in ['erainterim',]:
            ...
            if self.var_name in erainterim_raw_names.keys():
                ...
                raise UserWarning('var_name not recognised.')
        elif self.data_source in ['era5trp','era5plp','era5mcw','era5ewa'] and self.level_type=='plev':
            if self.var_name=='uwnd':
                ...
                self.raw_name='d'
        elif self.data_source in ['era5plp','era5bar','era5mcw','era5ewa'] and self.level_type=='sfc':
            if self.var_name=='uwnd':
                self.raw_name='u10'
            elif self.var_name=='vwnd':
                self.raw_name='v10'
