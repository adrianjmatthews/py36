...
class DataConverter(object):
    ...
    def read_cube(self):
        ...
        elif self.source in ['era5trp_plev_h','era5plp_plev_h','era5mcw_plev_h','era5plp_sfc_h','era5bar_sfc_h','era5mcw_sfc_h']:
        ...
        if self.data_source in ['erainterim',]:
            ...
            if self.var_name in erainterim_raw_names.keys():
                ...
                raise UserWarning('var_name not recognised.')
        elif self.data_source in ['era5trp','era5plp','era5mcw'] and self.level_type=='plev':
