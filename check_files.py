...
Also option to delete files (set REMOVE to True). Added this as manual
\rm * type command from unix prompt sometimes fails if large number of
files. Only use REMOVE option if manual \rm fails, as it is very slow
(sends separate delete command for each file).
...
CHECK='copernicus_get'; SOURCE='era5glo_plev_h'; SUBDIR='raw'
#CHECK='preprocess'; SOURCE='era5glo_plev_h'; SUBDIR='std'
#CHECK='regrid'; SOURCE='era5gloerai_plev_h'; SUBDIR='std'
#CHECK='time_average'; SOURCE='era5gloerai_plev_3h'; SUBDIR='std'
#
#CHECK='vrtbudget'; SOURCE='era5gloerai_plev_3h'; SUBDIR='std'
#
#CHECK='spatial_subset'; SOURCE='era5gloerai_plev_3h'; SUBDIR='processed'
#CHECK='wheelerkiladis'; SOURCE='era5gloerai_plev_3h'; SUBDIR='processed'
#CHECK='combine_latitudes'; SOURCE='era5gloeraiER2_plev_3h'; SUBDIR='std'
#CHECK='lagged_mean'; SOURCE='era5gloeraiER2_plev_3h'; SUBDIR='processed'
...
if REMOVE:
    if input("Warning. REMOVE is set to True. Confirm by entering 'y': ")!='y':
        raise UserWarning('Aborting.')

if CHECK=='copernicus_get':
    LOOPVAR1=VAR_NAMES
    LOOPVAR2=LEVELS
    LOOPVAR3=YEARS
    LOOPVAR4=MONTHS
    FILELENGTH_MIN=1390*1000000; FILELENGTH_MAX=1570*1000000
elif CHECK=='preprocess':
    LOOPVAR1=VAR_NAMES
    LOOPVAR2=LEVELS
    LOOPVAR3=YEARS
    LOOPVAR4=MONTHS
    FILELENGTH_MIN=2750*1000000; FILELENGTH_MAX=3150*1000000
elif CHECK=='regrid':
    LOOPVAR1=VAR_NAMES
    LOOPVAR2=LEVELS
    LOOPVAR3=YEARS
    LOOPVAR4=MONTHS
    FILELENGTH_MIN=340*1000000; FILELENGTH_MAX=400*1000000
elif CHECK in ['time_average','combine_latitudes','vrtbudget']:
    LOOPVAR1=VAR_NAMES
    LOOPVAR2=LEVELS
    LOOPVAR3=YEARS
    LOOPVAR4=MONTHS
    FILELENGTH_MIN=116*1000000; FILELENGTH_MAX=131*1000000
elif CHECK=='spatial_subset':
    LOOPVAR1=VAR_NAMES
    LOOPVAR2=LEVELS
    LOOPVAR3=LATITUDES
    LOOPVAR4=YEARS
    ...
    FILELENGTH_MIN=481*1000; FILELENGTH_MAX=534*1000
elif CHECK=='wheelerkiladis':
    LOOPVAR1=VAR_NAMES
    LOOPVAR2=LEVELS
    LOOPVAR3=LATITUDES
    #FILELENGTH_MIN=125000000; FILELENGTH_MAX=128000000
    FILELENGTH_MIN=295*1000000; FILELENGTH_MAX=305*1000000
elif CHECK=='lagged_mean':
    LOOPVAR1=VAR_NAMES
    LOOPVAR2=LEVELS
    LOOPVAR3=LONGITUDES
    FILELENGTH_MIN=17*1000000; FILELENGTH_MAX=18*000000
else:
        ...
        for s3 in LOOPVAR3:
            for s4 in LOOPVAR4:
                for s5 in LOOPVAR5:
                    ...
                    elif CHECK in ['copernicus_get','preprocess','regrid','time_average','combine_latitudes','vrtbudget']:
                    ...
                    if os.path.isfile(filec):
                        ...
                        if (FILELENGTH_MIN<=filec_length<=FILELENGTH_MAX):
                            nfiles+=1
                        else:
